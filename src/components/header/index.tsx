...
export function Header(){
    const buttonStyles = "bg-dark-500 border-1 border-gray-700 transition duration-300 linear hover:bg-gray-500 px-5 py-1.5 rounded-full focus:outline-2 focus:outline-gray-200";
